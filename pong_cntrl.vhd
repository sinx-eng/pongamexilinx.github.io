...
signal lscore, rscore: integer range 0 to 9 := 0;
 ...
 -- Divided clock frequency (25 MHz)
...
pipeline: process ( clk_25MHz, pixel, line)
begin
...
display: process (clk_25MHz, line, pixel, left_y, right_y, ball_x, ball_y, lscore, number_data, rscore)
begin
